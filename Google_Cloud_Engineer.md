...
REFERENCES
https://githubcom/in28minutes/course-material/blob/main/14-google-certified-professional-cloud-developer/downloadsmd
https://wwwgeeksforgeeksorg/difference-between-iaas-paas-and-saas/
-------------------------------------------------------------------------------------
...
13 By default all resources are shared among the customers of Google If a dedicated resource is required then 
    a sole-tenant node is to be created
...
- coreproject, computeregion, computezone
-------------------------------------------------------------------------------------
...
- PAAS (Platform As A Service)
	...
	- Cloud Run (CAAS Serverless): Develop and deploy highly scalable containerized apps. Does not need a cluster.
